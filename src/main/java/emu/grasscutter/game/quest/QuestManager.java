...
public class QuestManager extends BasePlayerManager {
	...
	@Transient
	@Getter
	private final List<Integer> loggedQuests;
    ...
    */
	...
	private static Set<Integer> newPlayerMainQuests = Set.of(
		303,
		318,
		348,
		349,
    ...
    */
	...
	public void onLogin() {
		...
		if (this.player.getActivityManager() != null) this.player.getActivityManager().triggerActivityConditions();
	}
	...
	public Integer getQuestGlobalVarValue(Integer variable) {
		return getPlayer().getQuestGlobalVariables().computeIfAbsent(variable, k -> this.getGlobalVarDefault(variable));
	}
	...
	public void startMainQuest(int mainQuestId) {
		...
		Arrays
			.stream(mainQuestData.getSubQuests())
	...
	public List<Integer> questsForDungeon(ScenePointEntry point) {
		...
		return this.getActiveMainQuests()
			.stream()
