		...
		if (target == null) {
			player.sendPacket(
				new PacketPlayerApplyEnterMpResultNotify(
					...
					"",
					false,
					PlayerApplyEnterMpResultNotifyOuterClass.PlayerApplyEnterMpResultNotify.Reason.REASON_PLAYER_CANNOT_ENTER_MP
				)
			);
			return;
		}
		...
		request
			...
			.sendPacket(
				new PacketPlayerApplyEnterMpResultNotify(
					hostPlayer,
					isAgreed,
					PlayerApplyEnterMpResultNotifyOuterClass.PlayerApplyEnterMpResultNotify.Reason.REASON_PLAYER_JUDGE
				)
			);
