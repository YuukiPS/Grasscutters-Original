...
public class TrialAvatarActivityHandler extends ActivityHandler {
	...
	public void onInitPlayerActivityData(PlayerActivityData playerActivityData) {
		TrialAvatarPlayerData trialAvatarPlayerData = TrialAvatarPlayerData.create(
			getActivityConfigItem().getScheduleId()
		);
	...
	public boolean getReward(Player player, int trialAvatarIndexId) {
		...
		player
			.getInventory()
			.addItemParamDatas(rewardParam.getRewardItemList(), ActionReason.TrialAvatarActivityFirstPassReward);
	...
	public void setPassDungeon(PlayerActivityData playerActivityData) {
		TrialAvatarPlayerData trialAvatarPlayerData = getTrialAvatarPlayerData(playerActivityData);
		TrialAvatarPlayerData.RewardInfoItem rewardInfo = trialAvatarPlayerData.getRewardInfo(
