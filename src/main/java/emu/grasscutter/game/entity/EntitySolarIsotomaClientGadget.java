...
public class EntitySolarIsotomaClientGadget extends EntityClientGadget {
	...
	public EntitySolarIsotomaClientGadget(
		Scene scene,
		Player player,
		EvtCreateGadgetNotifyOuterClass.EvtCreateGadgetNotify notify
	) {
	...
	public void onCreate() {
		...
		this.platformGadget =
			new EntitySolarIsotomaElevatorPlatform(this, getScene(), ELEVATOR_GADGET_ID, getPosition(), getRotation());
