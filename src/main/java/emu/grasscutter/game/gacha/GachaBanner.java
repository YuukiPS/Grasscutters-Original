...
public class GachaBanner {
	...
	@Getter
	private boolean autoStripRateUpFromFallback = true; // Ensures that featured items won't "double dip" into the losing pool

	private int[][] poolBalanceWeights4 = { { 1, 255 }, { 17, 255 }, { 21, 10455 } }; // Used to ensure that players won't go too many rolls without getting something from pool 1
	...
	public void onLoad() {
		...
		if (this.previewPrefabPath != null && this.previewPrefabPath.equals("UI_Tab_" + this.prefabPath)) Grasscutter
			.getLogger()
			.error(
		...
		if (this.previewPrefabPath == null || this.previewPrefabPath.isEmpty()) this.previewPrefabPath =
			"UI_Tab_" + this.prefabPath;
		...
		if (this.fallbackItems5Pool1 == null) this.fallbackItems5Pool1 = this.bannerType.fallbackItems5Pool1;
		if (this.fallbackItems5Pool2 == null) this.fallbackItems5Pool2 = this.bannerType.fallbackItems5Pool2;
	}
	...
	public GachaInfo toProto(Player player) {
		...
		GachaInfo.Builder info = GachaInfo
			.newBuilder()
