...
public class ProudSkillData extends GameResource {
	...
	@Transient
	@Getter
	private Object2FloatMap<String> paramListMap = new Object2FloatOpenHashMap<>();
	...
	public Iterable<ItemParamData> getTotalCostItems() {
		if (this.totalCostItems == null) {
			List<ItemParamData> total = (this.costItems != null) ? new ArrayList<>(this.costItems) : new ArrayList<>(1);
