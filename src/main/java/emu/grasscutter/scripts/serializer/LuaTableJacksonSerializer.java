...
public class LuaTableJacksonSerializer extends JsonSerializer<LuaTable> implements Serializer {
	...
	public <T> List<T> toList(Class<T> type, Object obj) {
		...
		Grasscutter
			.getLogger()
			.trace("[LuaTableToList] className={},data={}", type.getCanonicalName(), jsonNode.toString());
		if (jsonNode.isEmpty()) {
			return list;
		}
		if (jsonNode.isArray()) {
	...
	public <T> T toObject(Class<T> type, Object obj) {
		...
		Grasscutter
			.getLogger()
			.trace("[LuaTableToObject] className={},data={}", type.getCanonicalName(), jsonNode.toString());
		try {
	...
	public <T> Map<String, T> toMap(Class<T> type, Object obj) {
		...
		Grasscutter
			.getLogger()
			.trace("[LuaTableToMap] className={},data={}", type.getCanonicalName(), jsonNode.toString());
		try {
