...
public final class HttpJsonResponse implements Handler {
	...
	private final String[] missingRoutes = { // TODO: When http requests for theses routes are found please remove it
	...
	public void handle(@NotNull Context ctx) throws Exception {
		...
		if (
			DISPATCH_INFO.logRequests == ServerDebugMode.MISSING &&
			Arrays.stream(missingRoutes).anyMatch(x -> Objects.equals(x, ctx.endpointHandlerPath()))
		) {
			Grasscutter
				.getLogger()
				.info(
