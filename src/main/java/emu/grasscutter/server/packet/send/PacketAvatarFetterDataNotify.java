...
public class PacketAvatarFetterDataNotify extends BasePacket {
	...
	public PacketAvatarFetterDataNotify(Avatar avatar) {
		...
		AvatarFetterInfo.Builder avatarFetter = AvatarFetterInfo.newBuilder().setExpLevel(avatar.getFetterLevel());
		...
		AvatarFetterDataNotify proto = AvatarFetterDataNotify
			.newBuilder()
