...
public class PacketDungeonWayPointActivateRsp extends BasePacket {
	...
	public PacketDungeonWayPointActivateRsp(boolean success, int pointId) {
		...
		this.setData(
				DungeonWayPointActivateRspOuterClass.DungeonWayPointActivateRsp
					.newBuilder()
					.setWayPointId(pointId)
					.setRetcode(
						success ? RetcodeOuterClass.Retcode.RET_SUCC_VALUE : RetcodeOuterClass.Retcode.RET_FAIL_VALUE
					)
			);
	}
}
