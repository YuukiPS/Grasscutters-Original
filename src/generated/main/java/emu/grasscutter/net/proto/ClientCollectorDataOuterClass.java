...
public final class ClientCollectorDataOuterClass {
  ...
  public interface ClientCollectorDataOrBuilder extends
    ...
    /**
     * <code>uint32 NHALFDGLLPB = 1;</code>
     * @return The nHALFDGLLPB.
     */
    int getNHALFDGLLPB();

    /**
     * <code>uint32 PDFHFNPADNP = 6;</code>
     * @return The pDFHFNPADNP.
     */
    int getPDFHFNPADNP();
  ...
  private static final long serialVersionUID = 0L;
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 8: {
              ...
              nHALFDGLLPB_ = input.readUInt32();
              break;
            }
            case 48: {

              pDFHFNPADNP_ = input.readUInt32();
              break;
            }
            case 112: {
    ...
    public static final int NHALFDGLLPB_FIELD_NUMBER = 1;
    private int nHALFDGLLPB_;
    /**
     * <code>uint32 NHALFDGLLPB = 1;</code>
     * @return The nHALFDGLLPB.
     */
    @java.lang.Override
    public int getNHALFDGLLPB() {
      return nHALFDGLLPB_;
    }

    public static final int PDFHFNPADNP_FIELD_NUMBER = 6;
    private int pDFHFNPADNP_;
    /**
     * <code>uint32 PDFHFNPADNP = 6;</code>
     * @return The pDFHFNPADNP.
     */
    @java.lang.Override
    public int getPDFHFNPADNP() {
      return pDFHFNPADNP_;
    }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (nHALFDGLLPB_ != 0) {
        output.writeUInt32(1, nHALFDGLLPB_);
      }
      if (pDFHFNPADNP_ != 0) {
        output.writeUInt32(6, pDFHFNPADNP_);
      }
      if (materialId_ != 0) {
    ...
    public int getSerializedSize() {
      ...
      if (nHALFDGLLPB_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(1, nHALFDGLLPB_);
      }
      if (pDFHFNPADNP_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(6, pDFHFNPADNP_);
      }
      if (materialId_ != 0) {
        size += com.google.protobuf.CodedOutputStream
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (getNHALFDGLLPB()
          != other.getNHALFDGLLPB()) return false;
      if (getPDFHFNPADNP()
          != other.getPDFHFNPADNP()) return false;
      if (getMaterialId()
    ...
    public int hashCode() {
      ...
      hash = (37 * hash) + NHALFDGLLPB_FIELD_NUMBER;
      hash = (53 * hash) + getNHALFDGLLPB();
      hash = (37 * hash) + PDFHFNPADNP_FIELD_NUMBER;
      hash = (53 * hash) + getPDFHFNPADNP();
    ...
    public static final class Builder extends
      ...
      public emu.grasscutter.net.proto.ClientCollectorDataOuterClass.ClientCollectorData buildPartial() {
        ...
        result.nHALFDGLLPB_ = nHALFDGLLPB_;
        result.pDFHFNPADNP_ = pDFHFNPADNP_;
      ...
      public Builder mergeFrom(emu.grasscutter.net.proto.ClientCollectorDataOuterClass.ClientCollectorData other) {
        ...
        if (other.getNHALFDGLLPB() != 0) {
          setNHALFDGLLPB(other.getNHALFDGLLPB());
        }
        if (other.getPDFHFNPADNP() != 0) {
          setPDFHFNPADNP(other.getPDFHFNPADNP());
        }
      ...
      /**
       * <code>uint32 NHALFDGLLPB = 1;</code>
       * @param value The nHALFDGLLPB to set.
       * @return This builder for chaining.
       */
      public Builder setNHALFDGLLPB(int value) {
       ...
       * @return This builder for chaining.
       */
      public Builder clearNHALFDGLLPB() {
      ...
      /**
       * <code>uint32 PDFHFNPADNP = 6;</code>
       * @param value The pDFHFNPADNP to set.
       * @return This builder for chaining.
       */
      public Builder setPDFHFNPADNP(int value) {
       ...
       * @return This builder for chaining.
       */
      public Builder clearPDFHFNPADNP() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "lectorData\022\023\n\013NHALFDGLLPB\030\001 \001(\r\022\023\n\013PDFHF" +
      "NPADNP\030\006 \001(\r\022\023\n\013material_id\030\016 \001(\rB\033\n\031emu" +
    ...
    internal_static_ClientCollectorData_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_ClientCollectorData_descriptor,
        new java.lang.String[] { "NHALFDGLLPB", "PDFHFNPADNP", "MaterialId", });
  }
