...
public final class WidgetCoolDownDataOuterClass {
  ...
  public interface WidgetCoolDownDataOrBuilder extends
    ...
    /**
     * <code>uint64 cool_down_time = 1;</code>
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final int COOL_DOWN_TIME_FIELD_NUMBER = 1;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (coolDownTime_ != 0L) {
        output.writeUInt64(1, coolDownTime_);
      }
      if (id_ != 0) {
    ...
    public int getSerializedSize() {
      ...
      if (coolDownTime_ != 0L) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt64Size(1, coolDownTime_);
      }
      if (id_ != 0) {
        size += com.google.protobuf.CodedOutputStream
